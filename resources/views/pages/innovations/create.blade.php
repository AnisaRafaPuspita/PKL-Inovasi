                ...
                <div id="innovators-wrapper" class="space-y-3">
                    ...
                    <div class="innovator-item grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="innovators[0][type]" value="new">
                        </div>
    ...
    <div class="innovator-item grid grid-cols-1 md:grid-cols-2 gap-3">
        <div>
            ...
            <select
                ...
                <option value="">Atau pilih innovator yang sudah ada</option>
                @foreach ($innovators as $innovator)
                    <option value="{{ $innovator->id }}">{{ $innovator->name }}</option>
                @endforeach
            </select>

            <input type="hidden" name="innovators[${innovatorIndex}][type]" value="new">
        </div>
